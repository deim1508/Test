module my_data
    implicit none
    integer :: max_int = huge(max_int) !initialize_particles-ben haszn, szam generalas
    ...
    TYPE(particle), DIMENSION(:), ALLOCATABLE :: particles !malloc szeruseg
...
contains
    subroutine initialize_particles
        use my_data ! csak igy latjuk a globalis valtozokat
        ...
        do x = 1, N ! for ciklus
            ...
            do
                overlap = 0
                call random_number(u) ! 3 db random szam generalas
                ...
                if (overlap == 0) EXIT !nincs do while, ezert break
            end do
        ...
        print *, "Init done" !print consolra
...
program main
    use routines
    use my_data !ismerjuk a valtozokat
    implicit none !valami plusz, hibakezeles 
    real :: end_of_run = 0.0
    integer :: t = 0, x
    ...
    end_of_run = finish - start
    if (end_of_run <= 60) THEN
